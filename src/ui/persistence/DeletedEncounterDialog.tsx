...
export function DeletedEncounterDialog({
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div className="w-[min(32rem,92vw)] rounded-3xl border border-canvas-line bg-canvas-surface p-5 shadow-2xl">
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          <button className="rounded-xl bg-canvas-ink px-4 py-2 text-sm font-semibold text-canvas-on-ink" onClick={onCreate} type="button">
