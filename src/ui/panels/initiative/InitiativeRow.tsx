...
const activeFactionClasses: Record<Actor["layoutGroup"], string> = {
  ...
  enemy: "border-red-500 bg-red-50 dark:border-red-400 dark:bg-red-950",
  hero: "border-blue-500 bg-blue-50 dark:border-blue-400 dark:bg-blue-950",
  neutral: "border-yellow-500 bg-yellow-50 dark:border-yellow-400 dark:bg-yellow-950"
};

const activeIndicatorClasses: Record<Actor["layoutGroup"], string> = {
  ally: "bg-green-600 dark:bg-green-400",
  enemy: "bg-red-600 dark:bg-red-400",
  hero: "bg-blue-600 dark:bg-blue-400",
  neutral: "bg-yellow-600 dark:bg-yellow-400"
};
