...
function getWorker(): Worker | undefined {
  ...
  worker.addEventListener('message', (event: MessageEvent<ActorPlacementWorkerResponse>) => {
...
export function requestActorPlacementComputation(
  ...
  if (
    getCachedActorPlacementGeometry(cacheKey) &&
    !options.forceProactive
  ) {
    return;
  }
