...
export function EdgeToolButton({ activeToolId, edgeTool, encounter, tool }: Props) {
  ...
  return (
    <ToolbarOptionRow>
      <button
        ...
        className={`rounded-full border px-3 py-1.5 text-sm font-medium shadow-sm transition ${selected ? "border-canvas-ink bg-canvas-ink text-white" : "border-canvas-line bg-white text-canvas-ink"}`}
