...
import { getEntities, getEntityById } from '@core/state/entityCollection';
...
import {
  ...
  getZonelessActors,
  isActorZoneless
} from '@core/encounter/inspectors';
import type { EncounterState } from '@core/encounter/types';
import { ENCOUNTER_SCHEMA_VERSION, ZONELESS_ACTOR_ZONE_ID } from '@core/encounter/types';
...
describe('EncounterState foundation', () => {
  ...
  it('provides baseline inspection helpers for acceptance tests', () => {
    ...
    expect(getEdgesConnectedToZone(state, 'zone-courtyard')).toEqual([
      towerEdge
    ]);
